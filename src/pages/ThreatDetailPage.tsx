      ...
      realCases: [
        {
          ...
          description: 'Attackers used a targeted phishing email to compromise an RSA employee; stolen information weakened SecurID two-factor security for some customers.'
        },
        {
          title: 'Target Supply-Chain Phishing (2013)',
          description: 'Attackers phished credentials from an HVAC vendor, then used those credentials to access Target\'s network and exfiltrate customer payment data.'
        },
        {
          title: 'Sony Pictures (2014)',
          description: 'Spear-phishing and social engineering helped attackers gain footholds that led to a destructive breach and large data leak.'
        }
      ]
    },
    ransomware: {
